...
<section class="section supplier">
    <table class="table datatable">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('recycle.restore', ['type' => 'supplier', 'id' => $data->id]) }}" method="POST">
                                @csrf
            ...
            <div class="modal fade" id="deleteModal-{{ $data->id }}" tabindex="-1" aria-labelledby="deleteModalLabel-{{ $data->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('recycle.delete', ['type' => 'supplier', 'id' => $data->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        ...
        @empty
            <tr>
                <td colspan="8">No deleted supplier found.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
